// ќтсортировать массив положительных целых по количеству единичных разр€дов в машинном слове.
// ѕри выводе результата вывести 10 - ое и 16 - ое значение и количество разр€дов каждого элемента.
